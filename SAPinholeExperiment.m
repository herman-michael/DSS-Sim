function [ r ] = SAPinholeExperiment( args )
...
import ZOSAPI.*;
    ...
    % 1.55um pixel pitch
    % 9 apertures
    % 100um pinhole diameter
    % 0.03mm pinhole thickness
    
    close all; clc;
    
    % Saving paths
    save_path_training = 'C:\training_data\singleaperture\training\';
    save_path_validation = 'C:\training_data\singleaperture\validation\';
    save_path_testing = 'C:\training_data\singleaperture\testing\';
    ...
    seedsave.b =  seed1;
    seedsave.c =  seed2;
    save('SAPinholeExperimentSeed.mat','seedsave');
    ...
    newWin_Settings.ImageSampleSize =...
        ZOSAPI.Analysis.SampleSizes.S_128x128;
...
%     title('Huygens Cross Section');
    ...
    for i = 1:ap_N
        ap_deltax = (i - ap_N/2 - 1/2)*ap_pitch;
        for j = 1:ap_N
   ...
   imwrite(imgarr_full,[save_path num2str(alphar) '_' num2str(betar) '_0.png']);
    ...
    plot(imgarr_noise(256,256-40:256+40),'b--')
