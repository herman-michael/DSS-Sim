...
writecell(dataCellArrTrain,'sa_train.csv','QuoteStrings',false)
...
% Save the target data as csv
writecell(dataCellArrTest,'sa_test.csv','QuoteStrings',false)
...
% Save the target data as csv
writecell(dataCellArrValid,'sa_valid.csv','QuoteStrings',false)
