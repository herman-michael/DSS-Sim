...
writecell(dataCellArrTrain,'ma_train.csv','QuoteStrings',false)
...
% Save the target data as csv
writecell(dataCellArrTest,'ma_test.csv','QuoteStrings',false)
...
% Save the target data as csv
writecell(dataCellArrValid,'ma_valid.csv','QuoteStrings',false)
